...
This repository contains source code for a library useful to interact with the `state-machine-test-binary`. This binary can be used for canister integration tests.
